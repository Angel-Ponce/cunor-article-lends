    ...
    <AppLayout>
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[1250px]">
          <div className="flex items-center justify-around flex-wrap mb-4 bg-gray-50 p-4">
            <Statistic
              loading={loading}
          ...
          <div className="grid grid-cols-2 gap-4 h-[calc(100vh-350px)]">
            <div className="w-full h-full row-span-2 flex items-center justify-center bg-gray-50">
              <EChartsReact
