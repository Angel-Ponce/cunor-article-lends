...
export type MeQuery = {
  ...
  me?: {
    ...
    username: string;
    role: string;
    countActiveLends: number;
    countCompletedLends: number;
    institution: { __typename?: "Institution"; id: number; name: string };
    lends: Array<{ __typename?: "Lend"; id: number }>;
  } | null;
};
...
export type PhisicalStatesQuery = {
  __typename?: "Query";
  phisicalStates: {
    __typename?: "PhisicalStatePage";
    rows: Array<{
...
export type DeletePhisicalStateMutation = {
  __typename?: "Mutation";
  deletePhisicalState: { __typename?: "PhisicalState"; id: number };
};
...
export type CreatePhisicalStateMutation = {
  __typename?: "Mutation";
  createPhisicalState: { __typename?: "PhisicalState"; id: number };
};
...
export type UpdatePhisicalStateMutation = {
  __typename?: "Mutation";
  updatePhisicalState: { __typename?: "PhisicalState"; id: number };
};
...
export type DeleteProfessorMutation = {
  __typename?: "Mutation";
  deleteProfessor: { __typename?: "Professor"; id: number };
};
...
export type CreateProfessorMutation = {
  __typename?: "Mutation";
  createProfessor: { __typename?: "Professor"; id: number };
};
...
export type UpdateProfessorMutation = {
  __typename?: "Mutation";
  updateProfessor: { __typename?: "Professor"; id: number };
};
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "countActiveLends" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "countCompletedLends" },
                },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "lends" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
export const PhisicalStatesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "phisicalStates" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<PhisicalStatesQuery, PhisicalStatesQueryVariables>;
export const DeletePhisicalStateDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deletePhisicalState" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "deletePhisicalStateId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
  ...
  DeletePhisicalStateMutationVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createPhisicalState" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
>;
export const UpdatePhisicalStateDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updatePhisicalState" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "updatePhisicalStateId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
  ...
  UpdatePhisicalStateMutationVariables
>;
export const ProfessorsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "professors" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "page" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "length" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "personalRegister" },
                      },
                      { kind: "Field", name: { kind: "Name", value: "phone" } },
                    ],
                  },
...
} as unknown as DocumentNode<ProfessorsQuery, ProfessorsQueryVariables>;
export const DeleteProfessorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deleteProfessor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "deleteProfessorId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
  ...
  DeleteProfessorMutationVariables
>;
export const CreateProfessorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "createProfessor" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
...
export const UpdateProfessorDocument = {
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "updateProfessorId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
  ...
  UpdateProfessorMutationVariables
>;
